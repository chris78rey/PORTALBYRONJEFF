 ...
 */
@Embeddable
public class CantonesPK implements Serializable {
    ...
    public CantonesPK(String prvCodigo, String codigo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CantonesPK)) {
            return false;
        }
        CantonesPK other = (CantonesPK) object;
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.CantonesPK[ prvCodigo=" + prvCodigo + ", codigo=" + codigo + " ]";
    }
